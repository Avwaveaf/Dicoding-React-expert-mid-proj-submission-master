      ...
      <Card.Body>
        <div className="d-flex  gap-4">
          ...
          <div className="d-flex gap-1 w-100 ">
            <img data-testid="comments-imgUrl" src={data.owner.avatar} width={30} height={30} className="rounded-circle" alt="owner" />
            <div className="d-flex flex-column w-100">
              <span className="text-dark" data-testid="comments-owner-name">{ data.owner.name}</span>
              <span className="text-dark" data-testid="comments-createdAt">{formatDate(data.createdAt)}</span>
              <hr />
              <section className="mt-2 text-dark" data-testid="comments-content">
